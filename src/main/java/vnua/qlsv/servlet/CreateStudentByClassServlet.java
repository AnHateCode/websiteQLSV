...
@WebServlet(urlPatterns = {"/createStudent1"})
@MultipartConfig
public class CreateStudentByClassServlet extends HttpServlet {
	 ...
	 */
	public CreateStudentByClassServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String maCN = (String) request.getParameter("maCN");
