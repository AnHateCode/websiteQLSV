                        ...
                        <tr>
                            <td colspan="2">
                                <div class="book-details">
                                    <img id="bookImage" alt="BookImage" src="${sv.getAvatar()}" width="150">
                                    <div>
                                        <h2>Ma Khoa</h2>
                                        <p id="bookText">${sv.getMa_khoa()}</p>
                                    </div>
                                </div>
                            </td>
                        </tr>
