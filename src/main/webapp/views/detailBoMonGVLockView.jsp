...
<body>
    ...
    <div align="center" class="content">
        <h3>Chọn lý do khóa</h3>
        <p style="color: red">${errors }</p>
            <form action="detailBoMonGVLock" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="maGV" value="${maGV}" />
            <input type="hidden" name="maLH" value="${maLH}" />
                <table>
           
    <td>lý do </td>
    <td>
        <select name="trangThai">
            <option value=1>Chuyển công tác</option>
            <option value=2>Học cao học </option>
            <option value=3>Nghỉ việc</option>
             <option value=0>xóa khóa</option>
        </select>
    </td>
</tr>
<tr>
