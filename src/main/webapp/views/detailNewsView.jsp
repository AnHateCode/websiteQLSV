        ...
        <c:if test="${not empty news}">
            <div class="container1">
                <form id="detailBookForm" action="cartBook/addToCart" method="POST">
                    <input type="hidden" name="bookId" value="${news.id}" />
                    <table>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>${news.getNgayTao()}</td>
                        </tr>                                
                        <tr>
                            <td colspan="2">
                                <div class="book-details">
                                    <img id="bookImage" alt="BookImage" src="${news.getAnhBia()}" width="150">
                                    <div>
                                        <h2>Nội dung</h2>
                                        <p id="bookText">${news.getNoiDung()}</p>
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <tr align="center">
                            <td colspan="2"><a href="QLNewsHome">Bỏ qua</a></td>
                        </tr>
                    </table>
                </form>
            </div>
