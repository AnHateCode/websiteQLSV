...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
    <div class="container">
    <div class="dashboard">
        <a href="${pageContext.request.contextPath}/clientHome" class="logo-link">
            <img src="img/logo.png" alt="${pageContext.request.contextPath}/clientHome">
            <div>vnua.edu.vn</div>
        </a>
        ...
        <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/QLLopHoc">Quản lý lịch lớp học</a></li>
            <li><a href="${pageContext.request.contextPath}/QLLop">Quản lý Lớp của khoa</a></li>
            <li><a href="${pageContext.request.contextPath}/QLUserHome">Quản lý user</a></li>
